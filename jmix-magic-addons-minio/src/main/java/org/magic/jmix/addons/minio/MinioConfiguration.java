 ...
 */
@Configuration
@ComponentScan(basePackages = "org.magic.jmix.addons.minio")
@JmixModule(dependsOn = {FlowuiConfiguration.class, SecurityConfiguration.class})
@PropertySource(name = "org.magic.jmix.addons.minio", value = "classpath:/org/magic/jmix/addons/minio/module.properties")
public class MinioConfiguration {
    ...
    public ViewControllersConfiguration viewControllersConfiguration(
        ...
        viewControllers.setBasePackages(Collections.singletonList("org.magic.jmix.addons.minio.view"));
